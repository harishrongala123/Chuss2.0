...
class SelectedCarpenter extends StatefulWidget {

  final String uID;
  SelectedCarpenter(this.uID);

  @override
  _SelectedCarpenterState createState() => _SelectedCarpenterState();
}
...
class _SelectedCarpenterState extends State<SelectedCarpenter> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Carpenter').doc(id).snapshots();
    return Container(
