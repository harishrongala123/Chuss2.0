...
import 'CarpenterServices.dart';
import 'SelectedCarpenter.dart';
...
class TopPickedCarpenters extends StatefulWidget {

  @override
  _TopPickedCarpentersState createState() => _TopPickedCarpentersState();
}

class _TopPickedCarpentersState extends State<TopPickedCarpenters> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _CarpenterServices.getTopPickedTech(),
