...
import 'package:chuss/Customer-side/Services/Carpenter/CarpenterComponents/CarpenterServices.dart';
import 'package:chuss/Customer-side/Services/Carpenter/CarpenterComponents/SelectedCarpenter.dart';
...
class NearbyCarpenters extends StatefulWidget {

  @override
  _NearbyCarpentersState createState() => _NearbyCarpentersState();
}

class _NearbyCarpentersState extends State<NearbyCarpenters> {

  CarpenterServices _carpenterServices = CarpenterServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _carpenterServices.getNearByCarpenters(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Carpenters Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedCarpenter(document['phone'])
                                ));
                              },
                              child: Row(
