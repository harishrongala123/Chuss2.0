...
class TopPicked extends StatefulWidget {

  @override
  _TopPickedState createState() => _TopPickedState();
}

class _TopPickedState extends State<TopPicked> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _plumberServices.getTopPickedTech(),
