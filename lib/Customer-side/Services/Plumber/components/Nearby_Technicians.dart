import 'package:chuss/Customer-side/Services/Plumber/Selected_Tech/Selected_Tech.dart';
import 'package:chuss/Customer-side/Services/Plumber/components/PlumberServices.dart';
...
class NearByTech extends StatefulWidget {

  @override
  _NearByTechState createState() => _NearByTechState();
}

class _NearByTechState extends State<NearByTech> {
  PlumberServices _plumberServices = PlumberServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _plumberServices.getNearByPlumbers(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Plumbers Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedTechnician(document['phone'])
                                ));
                              },
                              child: Row(
