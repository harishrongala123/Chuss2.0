import 'package:chuss/Customer-side/Services/Catering/CateringComponents/CateringServices.dart';
import 'package:chuss/Customer-side/Services/Catering/CateringComponents/SelectedCatering.dart';
...
class NearByCatering extends StatefulWidget {

  @override
  _NearByCateringState createState() => _NearByCateringState();
}

class _NearByCateringState extends State<NearByCatering> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _cateringServices.getNearByCatering(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Caterings Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
