...
class SelectedCatering extends StatefulWidget {

  final String uID;
  SelectedCatering(this.uID);

  @override
  _SelectedCateringState createState() => _SelectedCateringState();
}
...
class _SelectedCateringState extends State<SelectedCatering> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Catering').doc(id).snapshots();
    return Container(
