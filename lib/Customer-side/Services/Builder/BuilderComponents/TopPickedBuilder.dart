...
class TopPickedBuilder extends StatefulWidget {

  @override
  _TopPickedBuilderState createState() => _TopPickedBuilderState();
}

class _TopPickedBuilderState extends State<TopPickedBuilder> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _builderServices.getTopPickedTech(),
