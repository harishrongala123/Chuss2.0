import 'package:chuss/Customer-side/Services/Builder/BuilderComponents/SelectedBuilder.dart';
import 'package:chuss/components/constants.dart';
import 'package:flutter/material.dart';
import 'BuilderServices.dart';
...
class NearByBuilders extends StatefulWidget {

  @override
  _NearByBuildersState createState() => _NearByBuildersState();
}

class _NearByBuildersState extends State<NearByBuilders> {
  BuilderServices _builderServices = BuilderServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _builderServices.getNearByBuilders(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Builders Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedBuilder(document['phone'])
                                ));
                              },
                              child: Row(
