...
class SelectedTailor extends StatefulWidget {

  final String uID;
  SelectedTailor(this.uID);

  @override
  _SelectedTailorState createState() => _SelectedTailorState();
}
...
class _SelectedTailorState extends State<SelectedTailor> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Tailor').doc(id).snapshots();
    return Container(
