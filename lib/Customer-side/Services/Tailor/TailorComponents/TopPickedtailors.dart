...
class TopPickedTailor extends StatefulWidget {

  @override
  _TopPickedTailorState createState() => _TopPickedTailorState();
}

class _TopPickedTailorState extends State<TopPickedTailor> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _tailorServices.getTopPickedTech(),
