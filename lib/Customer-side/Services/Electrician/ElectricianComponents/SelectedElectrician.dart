...
class SelectedElectrician extends StatefulWidget {

  final String uID;
  SelectedElectrician(this.uID);

  @override
  _SelectedElectricianState createState() => _SelectedElectricianState();
}
...
class _SelectedElectricianState extends State<SelectedElectrician> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Electrician').doc(id).snapshots();
    return Container(
