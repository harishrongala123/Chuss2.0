...
import 'package:chuss/Customer-side/Services/Electrician/ElectricianComponents/ElectricianServices.dart';
import 'SelectedElectrician.dart';
...
class NearbyElectricians extends StatefulWidget {

  @override
  _NearbyElectriciansState createState() => _NearbyElectriciansState();
}

class _NearbyElectriciansState extends State<NearbyElectricians> {
  ElectricianServices _electricianServices = ElectricianServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _electricianServices.getNearByElectricians(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Electricians Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedElectrician(document['phone'])
                                ));
                              },
                              child: Row(
