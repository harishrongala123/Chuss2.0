import 'package:chuss/Customer-side/Services/Electrician/ElectricianComponents/SelectedElectrician.dart';
import 'package:flutter/material.dart';
import 'ElectricianServices.dart';
...
class TopPickedElectricians extends StatefulWidget {

  @override
  _TopPickedElectriciansState createState() => _TopPickedElectriciansState();
}

class _TopPickedElectriciansState extends State<TopPickedElectricians> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _electricianServices.getTopPickedTech(),
