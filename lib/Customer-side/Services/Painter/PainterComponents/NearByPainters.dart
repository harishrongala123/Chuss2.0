...
import 'SelectedPainter.dart';

class NearByPainter extends StatefulWidget {

  @override
  _NearByPainterState createState() => _NearByPainterState();
}

class _NearByPainterState extends State<NearByPainter> {

  PainterServices _painterServices = PainterServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _painterServices.getNearByPainter(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Painter Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedPainter(document['phone'])
                                ));
                              },
                              child: Row(
