...
class SelectedPainter extends StatefulWidget {

  final String uID;
  SelectedPainter(this.uID);

  @override
  _SelectedPainterState createState() => _SelectedPainterState();
}
...
class _SelectedPainterState extends State<SelectedPainter> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Painter').doc(id).snapshots();
    return Container(
