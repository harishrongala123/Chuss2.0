...
class TopPickedPainter extends StatefulWidget {

  @override
  _TopPickedPainterState createState() => _TopPickedPainterState();
}

class _TopPickedPainterState extends State<TopPickedPainter> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _painterServices.getTopPickedTech(),
