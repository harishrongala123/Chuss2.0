...
import 'EventManagerServices.dart';
import 'SelectedEventManager.dart';
...
class NearByEventManager extends StatefulWidget {

  @override
  _NearByEventManagerState createState() => _NearByEventManagerState();
}

class _NearByEventManagerState extends State<NearByEventManager> {
  EventManagerServices _eventManagerServices = EventManagerServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _eventManagerServices.getNearByEventManager(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced EventManagers Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context)=>SelectedEventManager(document['phone'])
                                ));
                              },
                              child: Row(
