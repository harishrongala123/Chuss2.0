import 'package:chuss/Customer-side/Services/EventManager/EventManagerComponents/EventManagerServices.dart';
...
class TopPickedEventManager extends StatefulWidget {

  @override
  _TopPickedEventManagerState createState() => _TopPickedEventManagerState();
}

class _TopPickedEventManagerState extends State<TopPickedEventManager>{
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _eventManagerServices.getTopPickedTech(),
