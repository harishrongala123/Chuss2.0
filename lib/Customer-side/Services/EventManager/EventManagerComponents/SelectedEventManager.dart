...
class SelectedEventManager extends StatefulWidget {

  final String uID;
  SelectedEventManager(this.uID);

  @override
  _SelectedEventManagerState createState() => _SelectedEventManagerState();
}
...
class _SelectedEventManagerState extends State<SelectedEventManager> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('EventManager').doc(id).snapshots();
    return Container(
