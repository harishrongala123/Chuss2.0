...
class SelectedMechanic extends StatefulWidget {

  final String uID;
  SelectedMechanic(this.uID);

  @override
  _SelectedMechanicState createState() => _SelectedMechanicState();
}
...
class _SelectedMechanicState extends State<SelectedMechanic> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('Mechanic').doc(id).snapshots();
    return Container(
