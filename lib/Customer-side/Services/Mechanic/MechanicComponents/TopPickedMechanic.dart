import 'package:chuss/Customer-side/Services/Mechanic/MechanicComponents/MechanicServices.dart';
...
import 'SelectedMechanic.dart';

class TopPickedMechanic extends StatefulWidget {

  @override
  _TopPickedMechanicState createState() => _TopPickedMechanicState();
}

class _TopPickedMechanicState extends State<TopPickedMechanic> {

  MechanicServices _mechanicServices = MechanicServices();
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _mechanicServices.getTopPickedTech(),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context)=>SelectedMechanic(document['phone'])
                              ));
                            },
                            child: Padding(
