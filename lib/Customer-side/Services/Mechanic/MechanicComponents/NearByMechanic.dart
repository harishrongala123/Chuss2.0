...
class NearByMechanic extends StatefulWidget {
  ...
  @override
  _NearByMechanicState createState() => _NearByMechanicState();
}
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: _mechanicServices.getNearByMechanic(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'Find Out Experienced Mechanic Near You',
                              style: TextStyle(
                                color: Theme.of(context).accentColor,
                                fontSize: 12,
                              ),
